<x-default-layout section_title="Students" title="Students">
    @if (session('success'))
    ...
    @can('store-students')
    <div class="flex">
        <a href="{{route('students.create')}}" class="bg-green-50
         text-green-500 border border-green-500 
         px-3 py-2 flex items-center gap-2">
            <i href="{{ route('students.create') }}"
            class="ph ph-plus block text-green-500"></i>
