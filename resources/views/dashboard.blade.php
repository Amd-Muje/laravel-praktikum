<x-default-layout title="Dashboard" section_title="Dashboard">
    <div class="grid sm:grid-cols-2 md:grid-cold-3 gap-4"> 
        <div class="px-6 py-4 bg-sky-50 border hober:border-1-4 border-sky-400 space-y-1.5 shadow duration-200">
            <div class="text-zinc-600 text-sm">Total Students</div>
            <div class="text-2xl font-bold">521</div>
        </div>
        <div class="px-6 py-4 bg-green-50 border hober:border-1-4 border-green-400 space-y-1.5 shadow duration-200">
            <div class="text-zinc-600 text-sm" >Total Major</div>
