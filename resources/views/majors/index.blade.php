<x-default-layout section_title="Majors" title="Majors">
    @if (session('success'))
    ...
    <div class="flex">
        <a href="{{ route('majors.create') }}" class="bg-green-50
         text-green-500 border border-green-500 px-3 py-2 flex items-center gap-2">
            <i href="{{ route('majors.create') }}" class="ph ph-plus 
            block text-green-500"></i>
            <div>Add Major</div>
        </a>
    </div>
                    ...
                    <td class="py-3 px-6 flex justify-center gap-1">
                        ...
                        <a href="{{ route('majors.edit', $major->id) }}"
                           class="bg-yellow-50 border border-yellow-500 p-2 inline-block">
                            <i class="ph ph-note
                            -pencil block text-yellow-500"></i>
                        </a>
